...
trait HasSubscriptions
{
    ...
    {
        return $this->morphMany(config('weishaypt.subscriptions.models.plan_subscription'), 'user');
    }
     ...
     *
     * @return \Weishaypt\Subscriptions\Models\PlanSubscription|null
     */
    ...
    public function subscribedPlans(): ?PlanSubscription
    {
        ...
        return app('weishaypt.subscriptions.plan')->whereIn('id', $planIds)->get();
    }
     ...
     *
     * @return \Weishaypt\Subscriptions\Models\PlanSubscription
     */
